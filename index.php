        ...
        <div id="carouselExample" class="carousel slide image-shade" data-bs-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item active c-item" data-bs-interval="3000">
                    <img src="assets/img/game.jpg" class="d-block w-100 c-img overlay"
                        alt="..." style="height: 100vh;width:auto;">
                </div>
                <div class="carousel-item c-item" data-bs-interval="3000">
                    <img src="assets/img/c4.jpg" style="height: 100vh;width:auto;"
                        class="d-block w-100 c-img" alt="...">
                </div>
                <div class="carousel-item c-item" data-bs-interval="3000">
                    <img src="assets/img/events/ev2.jpg?version=0" style="height: 100vh;width:auto;"
                        class="d-block w-100 c-img" alt="...">
                </div>
                ...
                <div class="col-sm-12">
                    <div class="col-sm-12">
                        <div class="carousel-caption animated">
                            ...
                            <h1 class="slider-title  animated fadeInDown" style="animation-delay: 0.5s; animation-duration: 2s; margin-top: -35%; font-family: 'Poppins', sans-serif;">
                                <strong>COMPUTER & PROGRAMMING CLUB, KiU</strong>
                            </h1>
    ...
    <main id="main">
        ...
        <section id="portfolio" class="portfolio">
            <div class="container">
                <br><br><br>
                <div class="row">
                    <div class="section-title col-lg-12 col-md-12 col-sm-12 events-e" data-aos="fade-up">
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="400">
                        ...
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                ...
                                <div class="portfolio-links">
                                    <a href="  assets/img/events/ev1.jpg  " data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-other ">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                <h4>CPC-KiU Inauguration</h4>
                                <p>02 November 2023</p>
                                <div class="portfolio-links">
                                    <a href="  assets/img/events/ev-all.jpg  " data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="CPC-KiU Inauguration"><i class="bi bi-zoom-in"></i></a>
                                    <a href="#" title="More Details"><i class="bx bx-link"></i></a>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-other ">
                        <div class="portfolio-wrap">
                            ...
                            <div class="portfolio-info">
                                <h4>CPC-KiU Programming Camp 2023</h4>
                                <p>02 August 2023</p>
                                <div class="portfolio-links">
                                    <a href="  assets/img/events/ev-camp.jpg  " data-gallery="portfolioGallery"
                                        class="portfolio-lightbox" title="CPC-KiU Programming Camp 2023"><i class="bi bi-zoom-in"></i></a>
                                    <a href="#" title="More Details"><i class="bx bx-link"></i></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            ...
            <div class="row content">
              ...
              <div class="col-lg-1"></div>
                ...
                <!-- ======= Notice Section ======= -->
                <section id="notices" class="about col-lg-5 col-md-12">
                    <div class="container ">
                        <br><br><br>
                        <div class="section-title" data-aos="fade-up">
                            <h2>Notices</h2>
                        ...
                        <div class="feature col-lg-11 ">
                             ...
                             <div class="feature-content " data-aos="fade-up">
                                <h5><a href="#">The Competitive Programming Batch B class will resume on May 16.</a></h5>
                                <p><i>15 May 2024</i></p><br>
                            </div>
                         
                            <div class="feature-content " data-aos="fade-up">
                                <h5><a href="#">The Competitive Programming Batch is scheduled to commence on March 23, 2024</a></h5>
                                <p><i>20 March 2024</i></p><br>
                            </div>
                           
                          <div class="feature-content" data-aos="fade-up">

                              <a href="index#notices" > <button type="button" class="btn btn-primary view-all"
                                      data-aos="fade-up" style="width: 100%;">View all</button>
                              </a>
                          </div>
                    ...
                    <div class="container">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 d-flex align-items-stretch mt-4">
                          <div class="card" style='background-image: url("assets/img/course4.png");' data-aos="fade-up" data-aos-delay="100">
                            <div class="card-body">
                              <h5 class="card-title"><a href=""> Competitive Programming Batch A </a></h5>
                            <p>Advance programming, C++, STL, Data Structure and Algorithms, Graph, Greedy Algorithms... </p>
                        ...
                        <div class="col-md-6 d-flex align-items-stretch mt-4">
                          <div class="card" style='background-image: url("assets/img/course3.png");' data-aos="fade-up" data-aos-delay="200">
                            <div class="card-body">
                              <h5 class="card-title"><a href="">Competitive Programming Batch B</a></h5>
                             <p>Basic C Programming, if-else, array, loop, sorting, Binary search...</p>
                              <div class="read-more"><a href="#"><i class="bi bi-arrow-right"></i> Read More</a></div>
                            </div>
                          </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row d-flex align-items-stretch justify-content-center">
                    ...
                    <div class="col-lg-3 row-lg-3 col-md-6 d-flex align-items-stretch">
                       <a href="current_panel#team">
                        <div class="member" data-aos="fade-up" data-aos-delay="100">
                            <div class="member-img">
                                <img src="assets/img/team/core.png" class="img-fluid" alt="" style="height: 200px; width:300px">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <a href="current_panel#it">
                        <div class="member" data-aos="fade-up" data-aos-delay="200">
                            <div class="member-img">
                                <img src="assets/img/team/IT.png" class="img-fluid" alt="" style="height: 200px; width:300px">
                            </div>
                            <div class="member-info">
                                <h4>IT Wing</h4>
                                <span></span>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <a href="current_panel#executive">
                        <div class="member" data-aos="fade-up" data-aos-delay="200">
                            <div class="member-img">
                                <img src="assets/img/team/executive.png" class="img-fluid" alt="" style="height: 200px; width:300px">
                            </div>
                            <div class="member-info">
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch adv">
                        <a href="current_panel#finance">
                        <div class="member" data-aos="fade-up" data-aos-delay="300">
                            <div class="member-img">
                                <img src="assets/img/team/adv.png" class="img-fluid" alt="" style="height: 187px; width:300px">
                            </div>
                            <div class="member-info">
                                <h4 style="font-size:15px;">
                                    Advertising and Finance Management Wing
                                </h4>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <a href="current_panel#public">
                        <div class="member" data-aos="fade-up" data-aos-delay="200">
                            <div class="member-img">
                                <img src="assets/img/team/members.png" class="img-fluid" alt="" style="height: 200px; width:300px">
                            </div>
                            <div class="member-info">
                                <h4>Public Relations Wing</h4>
                                <span></span>
                            </div>
                        </div>
                        </a>
                    ...
                    <div class="col-lg-3 col-md-6 d-flex align-items-stretch">
                        <a href="current_panel#mentors">
                        <div class="member" data-aos="fade-up" data-aos-delay="400">
                            <div class="member-img">
                                <img src="assets/img/team/mentor.png" class="img-fluid" alt="" style="height: 200px; width:300px">

                            </div>
                            <div class="member-info">
                                <h4>Mentorship Wing</h4>
                    ...
                    <div class="col-lg-4 col-md-" data-aos="fade-up" data-aos-delay="100">
                        <div class="contact-about" style="">
                            ...
                            <div class="social-links">
                                ...
                                <a href="https://www.linkedin.com/company/103361395/" class="linkedin"><i class="bi bi-linkedin"></i></a>
                                <a href="https://www.youtube.com/@BCPC-official" class="linkedin"><i class="bi bi-youtube"></i></a>
                            </div>
                        </div>
                    </div>

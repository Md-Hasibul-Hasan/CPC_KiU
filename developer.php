...
<head>
    ...
    <meta content="" name="keywords">
      ...
      <!-- Favicons -->
  <!-- <link rel="icon" type="image/x-icon" href="assets/img/bsmru_logo.ico">-->
     <!-- Favicons -->
...
<link href="https://fonts.googleapis.com/css?family=Open+Sans:300,300i,400,400i,600,600i,700,700i|Nunito:300,300i,400,400i,600,600i,700,700i|Poppins:300,300i,400,400i,500,500i,600,600i,700,700i" rel="stylesheet">
  ...
  <!-- Vendor CSS Files -->
  <link href="./assets/dev/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
  <link href="./assets/dev/vendor/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
  <link href="./assets/dev/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="./assets/dev/vendor/quill/quill.snow.css" rel="stylesheet">
  <link href="./assets/dev/vendor/quill/quill.bubble.css" rel="stylesheet">
  <link href="./assets/dev/vendor/remixicon/remixicon.css" rel="stylesheet">
  <link href="./assets/dev/vendor/simple-datatables/style.css" rel="stylesheet">

  <!-- Template Main CSS File -->
  <link href="./assets/dev/css/style.css" rel="stylesheet">
                ...
                <div class="col-xl-7 ">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            <img src="./assets/img/developer/advisor.jpg" alt="Profile" class="rounded-circle">
...
<!-- Vendor JS Files -->
<script src="./assets/dev/vendor/apexcharts/apexcharts.min.js"></script>
  <script src="./assets/dev/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="./assets/dev/vendor/chart.js/chart.umd.js"></script>
  <script src="./assets/dev/vendor/echarts/echarts.min.js"></script>
  <script src="./assets/dev/vendor/quill/quill.min.js"></script>
  <script src="./assets/dev/vendor/simple-datatables/simple-datatables.js"></script>
  <script src="./assets/dev/vendor/tinymce/tinymce.min.js"></script>
  <script src="./assets/dev/vendor/php-email-form/validate.js"></script>
